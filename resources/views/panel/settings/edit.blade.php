        ...
        <div class="col">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form autocomplete="off" role="form" action="{{ route('settings.update') }}" method="post">
                        <input type="hidden" name="_token" value="{{{ csrf_token() }}}" />

                        <div class="form-group">
                            <label class="control-label" for="template">Mail Driver: </label>
                            <select class="form-control" name="mail_driver_id">
                                <option> - - -</option>
